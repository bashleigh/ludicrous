...
// src/provider.ts
var isValueProvider = (provider) => provider.hasOwnProperty("token") && provider.hasOwnProperty("useValue");
var isTokenProvider = (provider) => provider.hasOwnProperty("token") && provider.hasOwnProperty("useClass");
var isConstructorProvider = (provider) => (
  // @ts-ignore
  !!provider.prototype && !!provider.prototype.constructor.name
);

// src/metadata.container.ts
var AbstractMetadataContainer = class {
  constructor(bootLogging = true) {
...
var RouteMetadataContainer = class extends AbstractMetadataContainer {
  resolvePathToRouteMetadata(path, method) {
    let match2 = false;
    const metadata = Object.values(this.metadata).find((metadata2) => {
      match2 = metadata2.match(path);
      return metadata2.httpMethod === method && match2;
    });
    return metadata && match2 ? {
      ...metadata,
      match: match2
    } : void 0;
  }
  add(metadata) {
    this.bootLogging && console.log(
...
var HTTP_RESPONSE = /* @__PURE__ */ ((HTTP_RESPONSE2) => {
  HTTP_RESPONSE2["OK"] = "OK";
  HTTP_RESPONSE2["CREATED"] = "CREATED";
  HTTP_RESPONSE2["ACCEPTED"] = "ACCEPTED";
  HTTP_RESPONSE2["NO_CONTENT"] = "NO_CONTENT";
  HTTP_RESPONSE2["RESET_CONTENT"] = "RESET_CONTENT";
  HTTP_RESPONSE2["PARTIAL_CONTENT"] = "PARTIAL_CONTENT";
  HTTP_RESPONSE2["BAD_REQUEST"] = "BAD_REQUEST";
  HTTP_RESPONSE2["UNAUTHORIZED"] = "UNAUTHORIZED";
  HTTP_RESPONSE2["PAYMENT_REQUIRED"] = "PAYMENT_REQUIRED";
  HTTP_RESPONSE2["FORBIDDEN"] = "FORBIDDEN";
  HTTP_RESPONSE2["NOT_FOUND"] = "NOT_FOUND";
  HTTP_RESPONSE2["METHOD_NOT_ALLOWED"] = "METHOD_NOT_ALLOWED";
  HTTP_RESPONSE2["NOT_ACCEPTED"] = "NOT_ACCEPTED";
  HTTP_RESPONSE2["CONFLICT"] = "CONFLICT";
  HTTP_RESPONSE2["UNPROCESSABLE_CONTENT"] = "UNPROCESSABLE_CONTENT";
  HTTP_RESPONSE2["INTERNAL_SERVER_ERROR"] = "INTERNAL_SERVER_ERROR";
...
var HttpException = class extends Error {
  get httpCode() {
    return HTTP_STATUS_CODE[this.httpRespsonse || "INTERNAL_SERVER_ERROR" /* INTERNAL_SERVER_ERROR */];
  }
  constructor(message) {
...
var BadRequestException = class extends HttpException {
  constructor() {
    super(...arguments);
    this.httpRespsonse = "BAD_REQUEST" /* BAD_REQUEST */;
  }
};
var UnauthorizedException = class extends HttpException {
  constructor() {
    super(...arguments);
    this.httpRespsonse = "UNAUTHORIZED" /* UNAUTHORIZED */;
  }
};
var ForbiddenException = class extends HttpException {
  constructor() {
    super(...arguments);
    this.httpRespsonse = "FORBIDDEN" /* FORBIDDEN */;
  }
};
var NotFoundException = class extends HttpException {
  constructor(message) {
    super(message || "Not Found");
    this.httpRespsonse = "NOT_FOUND" /* NOT_FOUND */;
  }
};
var MethodNotAllowedException = class extends HttpException {
  constructor() {
    super(...arguments);
    this.httpRespsonse = "METHOD_NOT_ALLOWED" /* METHOD_NOT_ALLOWED */;
  }
};
var NotAcceptedException = class extends HttpException {
  constructor() {
    super(...arguments);
    this.httpRespsonse = "NOT_ACCEPTED" /* NOT_ACCEPTED */;
  }
};
var ConflictException = class extends HttpException {
  constructor() {
    super(...arguments);
    this.httpRespsonse = "CONFLICT" /* CONFLICT */;
  }
};
var UnprocessableContentException = class extends HttpException {
  constructor() {
    super(...arguments);
    this.httpRespsonse = "UNPROCESSABLE_CONTENT" /* UNPROCESSABLE_CONTENT */;
  }
};
...
var HttpApplicationContainer = class extends AbstractApplicationContainer {
  constructor() {
    ...
    this.handle = async (event, context) => {
      ...
      try {
        ...
        const controller = this.get(route.controllerToken);
        console.log("controller", controller[route.method]);
        const argumentMetadata = Reflect.getMetadata(`${ARGUMENT}::${route.method.toString()}`, controller) || [];
        const args = argumentMetadata.map(
          (metadata) => this.mapArgumentMetadataToValues(metadata, {
  ...
  mapArgumentMetadataToValues({ name, type }, {
    ...
    switch (type) {
      case "QUERY":
        return query ? query[name] || void 0 : void 0;
      case "PARAMETER":
...
var DevHttpApplicationContainer = class extends HttpApplicationContainer {
  ...
  serve(port = 3e3) {
    ...
    return import_http.default.createServer(async (request, response) => {
      var _a;
      const [path, query] = (_a = request.url) == null ? void 0 : _a.split("?");
